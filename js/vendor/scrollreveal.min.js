    ...
    return function() {
        ...
        this.ScrollReveal = function() {
            ...
            return i.prototype.defaults = {
                ...
                var c, y, m, g, p, v;
                if (c = n && n.container ? o(n) : e.defaults.container, y = e.tools.isNode(t) ? [t] : Array.prototype.slice.call(c.querySelectorAll(t)), !y.length) return console.log('ScrollReveal: reveal on "' + t + '"" failed, no elements found.'), e;
                n && "number" == typeof n && (i = n, n = {}), i && "number" == typeof i && (v = r(), p = e.sequences[v] = {
                    id: v,
                    interval: i,
                    elemIds: [],
                    active: !1
                });
                for (var w = 0; w < y.length; w++) g = y[w].getAttribute("data-sr-id"), g ? m = e.store.elements[g] : (m = {
                    id: r(),
                    domEl: y[w],
                    seen: !1,
                    revealing: !1
                }, m.domEl.setAttribute("data-sr-id", m.id)), p && (m.sequence = {
                    id: p.id,
                    index: p.elemIds.length
                }, p.elemIds.push(m.id)), s(m, n || {}), a(m), f(m), e.tools.isMobile() && !m.config.mobile || !e.isSupported() ? (m.domEl.setAttribute("style", m.styles.inline), m.disabled = !0) : m.revealing || m.domEl.setAttribute("style", m.styles.inline + m.styles.transform.initial);
